# 'user_input_validation_week3.py'
# CCOMP-11P-4316 - Fall 2020
# Written By: Christian Million
# Last Modified: 2020-08-29
#
# Fork your dice program. (Fork is a version management word for creating a different version while leaving the original intact. Think 'Save As'.)
# Be sure to leave your old dice program intact.
# In the new fork, you should validate your user's input and
# include some error handling. Possible sources of error are invalid inputs or numbers that are too large or negative. 
# Maybe there are more?

# NOTE THIS IS JUST MY ORIGINAL DICE ROLLING SCRIPT
# I HAD ALREADY INCLUDED A LOT OF THAT STUFF
